            ...
            <form id="formulario">
                ...
                <div class="row">
                    <div class="input-field col m4 offset-m1 s12">
                        ...
                        <input id="curp" name = "curp" type="text" class="validate" data-validetta="required">
                        <label for="curp">CURP</label>
                    </div>            
                    <div class="input-field col m4 offset-m2 s12">
                        <i class="material-icons prefix">enhanced_encryption</i>
                        <input id="contrasena" name = "contrasena" type="password" class="validate" data-validetta = "required">
                ...
                <div class="row">
                    <div class="col s12 m4 offset-m4 input-field">
                        <button class="btn" type="submit" style="width: 100%" id = "btn">Login</button>
                    </div>
                </div>
            </form>
